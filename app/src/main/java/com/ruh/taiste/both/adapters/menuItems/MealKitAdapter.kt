...
class MealKitAdapter(private val context: Context, private var mealKitItems: MutableList<FeedMenuItems>, private var chefOrUser: String, private var city: String, private var state: String, private var zipCode: String) : RecyclerView.Adapter<MealKitAdapter.ViewHolder>()  {
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        holder.editItemButton.setOnClickListener {
            ...
            intent.putExtra("item_label", "MealKit Items")
    ...
    class ViewHolder(itemView: ChefItemPostBinding) : RecyclerView.ViewHolder(itemView.root) {
        ...
        fun bind(item: FeedMenuItems) {
            ...
            storage.reference.child("chefs/${item.chefEmail}/MealKit Items/${item.menuItemId}0.png").downloadUrl.addOnSuccessListener { itemUri ->
