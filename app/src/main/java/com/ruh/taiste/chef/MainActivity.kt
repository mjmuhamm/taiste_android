...
import com.ruh.taiste.chef.fragments.Dashboard
import com.ruh.taiste.databinding.ActivityMainChefBinding
import com.ruh.taiste.chef.fragments.Me
import com.ruh.taiste.chef.fragments.Orders
...
class MainActivity : AppCompatActivity() {
    private lateinit var binding: ActivityMainChefBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityMainChefBinding.inflate(layoutInflater)
        ...
        binding.navView.setOnItemSelectedListener { item ->
            when (item.itemId) {
                R.id.nav_dashboard -> {
                    b()
                    binding.navView.menu[0].setIcon(R.drawable.dashboard_filled).iconTintList = iconColorStatesGray
        ...
        val whereTo = intent.getStringExtra("where_to").toString()
        if ( whereTo == "login") {
            a()
            moveToFragment(Feed())
