...
import com.ruh.taiste.chef.YoutubeView
import com.ruh.taiste.databinding.ActivityGuideToCaterItemsBinding
...
class GuideToCaterItems : AppCompatActivity() {
    private val db = Firebase.firestore
    private lateinit var binding : ActivityGuideToCaterItemsBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityGuideToCaterItemsBinding.inflate(layoutInflater)
